...
export function VivrProject(){return <main className="vivr-page">
  ...
  <section className="demo-stage"><div className="demo-stage-head"><div><span className="eyebrow">STATIC INTERACTIVE DEMO</span><h2>The real interface,<br/>without the API.</h2></div><p>Modeled directly on vivrAI’s actual red-and-white navigation and Daily Feed. Everything below uses fixed sample data in your browser.</p></div><StaticDemo/></section>
